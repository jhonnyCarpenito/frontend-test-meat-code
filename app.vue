  ...
  <Html lang="es">
    ...
    <main class="articles_container">
      ...
      <section>
        ...
        <!-- Formulario-->
        <Form class="newsletter_form" @submit="handleSubmit" v-slot="{errors}">
          <div class="newsletter_inputs_container">
            <div>
              <label class="newsletter-input-text" for="name">NOMBRE</label>
              <Field name="name" type="text" v-model="form.firstname"
            ...
            <div>
              ...
              <Field name="lastname" type="text" v-model="form.lastname"
                class="newsletter_input"
                :class="{'error_input': errors.lastname}"
            ...
            <div>
              ...
              <Field name="phone" type="tel" v-model="form.phone"
                class="newsletter_input"
